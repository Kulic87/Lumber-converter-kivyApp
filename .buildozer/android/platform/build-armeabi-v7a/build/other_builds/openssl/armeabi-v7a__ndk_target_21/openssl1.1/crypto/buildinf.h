...
#define DATE "built on: Fri Jun 26 22:15:56 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','y','u','r','a',
    '/','D','e','s','k','t','o','p','/','t','e','s','t','/','.','b',
